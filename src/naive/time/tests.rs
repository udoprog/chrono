...
fn test_time_from_hms_milli() {
    ...
    assert_eq!(
        NaiveTime::from_hms_milli(3, 5, 7, 1_999),
        Ok(NaiveTime::from_hms_nano(3, 5, 7, 1_999_000_000).unwrap())
    );
...
fn test_time_from_hms_micro() {
    ...
    assert_eq!(
        NaiveTime::from_hms_micro(3, 5, 7, 1_999_999),
        Ok(NaiveTime::from_hms_nano(3, 5, 7, 1_999_999_000).unwrap())
    );
